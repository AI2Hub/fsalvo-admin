 ...
 */
#[handler]
pub async fn add_sys_role(req: &mut Request, depot: &mut Depot, res: &mut Response) {
 ...
 */
#[handler]
pub async fn delete_sys_role(req: &mut Request, depot: &mut Depot, res: &mut Response) {
 ...
 */
#[handler]
pub async fn update_sys_role(req: &mut Request, depot: &mut Depot, res: &mut Response) {
    ...
    if SysRole::find_by_id(item.id.clone())
        ...
        .is_none()
    {
        return BaseResponse::<String>::err_result_msg(res, "角色信息不存在,不能更新!".to_string());
    }
 ...
 */
#[handler]
pub async fn update_sys_role_status(req: &mut Request, depot: &mut Depot, res: &mut Response) {
 ...
 */
#[handler]
pub async fn query_sys_role_detail(req: &mut Request, depot: &mut Depot, res: &mut Response) {
 ...
 */
#[handler]
pub async fn query_sys_role_list(req: &mut Request, depot: &mut Depot, res: &mut Response) {
